...
# load data
pickle_jar = '/home/ubuntu/inphormed/pickles/nn_models/'
...
def main():
    ...
    vectorizer = CountVectorizer(ngram_range=(1,2),
                                 min_df=5, 
                                 max_features=10000) # (1,1), (1,2), (2,2)
    ...
    # save model
    nn_model_path = '/home/ubuntu/inphormed/pickles/nn_models/'
    with open(os.path.join(nn_model_path,'vectorizer_uni_bi_min_5_max_10k.pckl'), 'wb') as p:
        pickle.dump(vectorizer, p, protocol=pickle.HIGHEST_PROTOCOL)
    nn.save(os.path.join(nn_model_path,'nn_model_uni_bi_min_5_max_10k.h5'))
